...
(function (win, $) {
  ...
  function createTL() {
    return gsap
      .timeline({ paused: true, reversed: true, overwrite: true })
      .to(
        '.js-wrap-texture',
  ...
  $(win).ready(function () {
      ...
      animation.useMousePosition({
        ...
        onUpdate: (x, y) => {
          ...
          $(card).css({
            ...
            'background-position':
              cursorPercentX * 0.4 + '% ' + cursorPercentY * 0.8 + '%',
          });
          $(card)
            .find('.js-card-img')
            .css({
    ...
    let textTL = gsap.timeline({ paused: true, reversed: true }).fromTo(
      '.js-charactor-text',
      {
        opacity: 0,
      },
      ...
      onScrolling: function (current) {
        ...
        if (
          ...
          if (subscribeProgress >= 0.7) {
            ...
            for (let i = 0; i < allItemSubscribeLabel.length; i++) {
              ...
              $(item).css({
                transform:
                  'translateY(' + -(progress * 12 * allRandomIndex[i]) + 'px) ',
                // opacity: 1 - subscribeProgress * allRandomIndex[i],
              });
            }
            $('.js-subscribe-content').css({
              transform:
                contentTransform + 'scale(' + (1 - progress * 0.06) + ')',
            });
        ...
        if (
          ...
          if (scheduleProgress >= 0.7) {
            ...
            $('.js-schedule-charactor').css({
              transform:
                charactorTransform + 'scale(' + (1 - progress * 0.1) + ')',
            });
          } else {
            $('.js-schedule-content').css({
              transform: contentTransform,
        ...
        if (
          ...
          for (let i = 0; i < allItemBrandsTitle.length; i++) {
            ...
            $(item).css({
              transform:
                'translateY(' + -(brandsProgress * 20 * (i + 1)) + 'px) ',
            });
          }
        ...
        if (
          ...
          if (aboutProgress >= 0.7) {
            ...
            $('.js-about-middle').css({
              transform:
                middleTransform + 'scale(' + (1 - progress * 0.06) + ')',
            });
          } else {
            $('.js-about-middle').css({
          ...
          for (let i = 0; i < allItemAboutTitle.length; i++) {
            ...
            $(item).css({
              transform:
                'translateY(' + -(aboutProgress * 20 * (i + 1)) + 'px) ',
            });
          }
        } else if (current < $('.js-section-brands').offset().top) {
