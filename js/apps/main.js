...
(function (win, $) {
  ...
  $(win).ready(function () {
    ...
    $('.js-about-title').html(
      ...
      .map(function (char, i) {
        let text =
          '<span aria-hidden="true" class="about__title-item js-about-title-item">' +
          char +
          '</span>';
    ...
    $('.js-brands-title').html(
      ...
      .map(function (char, i) {
        let text =
          '<span aria-hidden="true" class="brands__title-item js-brands-title-item">' +
          char +
          '</span>';
    ...
    $('.js-subscribe-label').html(
      ...
      .map(function (char, i) {
        let text =
          '<span aria-hidden="true" class="item js-subscribe-label-item">' +
          char +
          '</span>';
    ...
    $('.js-schedule-title').html(
      ...
      .map(function (char, i) {
        let text =
          '<span aria-hidden="true" class="schedule__title-item js-schedule-title-item">' +
          char +
          '</span>';
    ...
    $('.js-subscribe-subtitle').html(
      ...
      .map(function (char, i) {
        let text =
          '<span aria-hidden="true" class="subscribe__title-item js-subscribe-title-item">' +
          char +
          '</span>';
    ...
    let allCards = [
      ...$('.js-featured-card').toArray(),
      ...$('.js-blogs-card').toArray(),
    ];
    ...
    smoothScroll = animation.useSmoothScroll({
      ...
      onScrolling: function (current) {
        ...
        if (
          current >= $('.js-section-subscribe').offset().top &&
          current <=
          $('.js-section-subscribe').offset().top +
          $('.js-section-subscribe').innerHeight()
        ) {
          let subscribeProgress =
            (current - $('.js-section-subscribe').offset().top) /
            $('.js-section-subscribe').innerHeight();
          ...
          let contentTransform =
            'translateY(' + subscribeProgress * 250 + 'px) ';
          if (subscribeProgress >= 0.7) {
            let minus = 0.7 * $('.js-section-subscribe').innerHeight();

            let progress =
              (current - $('.js-section-subscribe').offset().top - minus) /
              ($('.js-section-subscribe').innerHeight() - minus);
          ...
          for (let i = 0; i < allItemSubscribeTitle.length; i++) {
            ...
            $(item).css({
              transform: 'translateY(' +
                -(subscribeProgress * 20 * (allItemSubscribeTitle.length - i)) +
                'px) ',
            });
          }
        ...
        if (
          current >= $('.js-section-schedule').offset().top &&
          current <=
          $('.js-section-schedule').offset().top +
          $('.js-section-schedule').innerHeight()
        ) {
          ...
          let contentTransform =
            'translateY(' + scheduleProgress * 250 + 'px) ';

          $('.js-schedule-subtitle').css({
            opacity: 1 - scheduleProgress,
            transform: 'translateY(' + scheduleProgress * 300 + 'px) ',
          });
          let charactorTransform =
            'translateY(' + scheduleProgress * 500 + 'px) rotateY(-180deg)';

          if (scheduleProgress >= 0.7) {
            let minus = 0.7 * $('.js-section-schedule').innerHeight();
            let progress =
              (current - $('.js-section-schedule').offset().top - minus) /
              ($('.js-section-schedule').innerHeight() - minus);
          ...
          for (let i = 0; i < allItemScheduleTitle.length; i++) {
            ...
            $(item).css({
              transform: 'translateY(' +
                -(scheduleProgress * 20 * (allItemScheduleTitle.length - i)) +
                'px) ',
            });
          }
        ...
        if (
          current >= $('.js-section-brands').offset().top &&
          current <=
          $('.js-section-brands').offset().top +
          $('.js-section-brands').innerHeight()
        ) {
          let brandsProgress =
            (current - $('.js-section-brands').offset().top) /
            $('.js-section-brands').innerHeight();
          ...
          if (brandsProgress >= 0.7) {
            ...
            let progress =
              (current - $('.js-section-brands').offset().top - minus) /
              ($('.js-section-brands').innerHeight() - minus);
        ...
        if (
          current >= $('.js-section-about').offset().top &&
          current <=
          $('.js-section-about').offset().top +
          $('.js-section-about').innerHeight()
        ) {
          let aboutProgress =
            (current - $('.js-section-about').offset().top) /
            $('.js-section-about').innerHeight();
          ...
          if (aboutProgress >= 0.7) {
            ...
            let progress =
              (current - $('.js-section-about').offset().top - minus) /
              ($('.js-section-about').innerHeight() - minus);
        ...
        if (
          current >= $('.js-section-spot').offset().top &&
          current <=
          $('.js-section-spot').offset().top +
          $('.js-section-spot').innerHeight()
        ) {
          let spotProgress =
            (current / $('.js-section-spot').innerHeight()) * 100;
    ...
    $('.js-charactor-text').html(
      ...
      .map(function (char, i) {
        let text =
          '<span aria-hidden="true"  style="transform: rotate( ' +
          (i - 2) * 10 +
          'deg)" class="item">' +
          char +
          '</span>';
